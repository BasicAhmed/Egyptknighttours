  ...
  return (
    <footer className="mt-24 border-t border-ink/10 bg-ink text-white">
      <div className="container-x grid gap-8 py-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <nav aria-label="Help" className="text-sm"><p className="font-semibold text-gold-500">Help</p><ul className="mt-2 space-y-1 text-white/80"><li><Link href="/plan-my-trip">Build my Egypt trip</Link></li><li><Link href="/track">Track my booking</Link></li><li><Link href="/contact">Contact</Link></li><li><Link href="/faq">FAQ</Link></li><li><Link href="/admin/login" rel="nofollow">Staff login</Link></li></ul></nav>
      </div>
